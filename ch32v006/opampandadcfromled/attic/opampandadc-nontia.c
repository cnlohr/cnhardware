...
void adc_init( void )
{
	...
	ADC1->SAMPTR2 |= 1<<(3*9);	// 0:7 => 3.5/7.5/11.5/19.5/35.5/55.5/71.5/239.5 cycles
...
int main()
{
	...
	// PSEL (Drive low (Not used, sort of))
	...
	OPA->CTLR1 =
		...
		0 | // Disconnect PSEL1.
		(0b110<<8) | // Connect NSEL1 through RS1 to PGADIF (may be GND or PA4 (vcc))
